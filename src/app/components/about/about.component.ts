...
export class AboutComponent implements OnInit {
  competences = [
    ...
    { icon: "emoji_objects", title: "Resolución de problemas", description: "Uso mis destrezas lógicas y analíticas para responder a problemas complejos y difíciles. Soy sistemática, metódica y disciplinada. Tengo un alto sentido de la responsabilidad con el trabajo asignado. Sé priorizar los asuntos, cumplir con los objetivos y entregar el trabajo en tiempo y forma." },
