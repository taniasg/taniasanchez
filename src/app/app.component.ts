...
export class AppComponent {
  ...
  menu: Array<object> = [
    ...
    { name: 'Sobre Mí', route: '/about', icon: 'person' },
    { name: 'Habilidades', route: '/skills', icon: 'star' }
  ]
  ...
  setTheme() {
    let theme = this.uitheme == 'light-theme' ? "dark-theme" : "light-theme";
